...
internal sealed class NoteHubCon : IAsyncDisposable
{
    ...
    private readonly NoteEventRelay _noteEventRelay;
    ...
    /// <param name="noteEventRelay">The relay service that forwards hub events to subscribers.</param>
    public NoteHubCon(NoteHubConOptions options, NoteEventRelay noteEventRelay)
    {
        _hubConnection = new HubConnectionBuilder()
            ...
            .Build();
        ConfigureListeners();
        _noteEventRelay = noteEventRelay;
    }
    ...
    {
        _hubConnection.On<NoteDto>(MNotesRoutes.Hubs.MethodNames.NoteCreated, dto => _noteEventRelay.SendNoteCreated(dto));
        _hubConnection.On<NoteDto>(MNotesRoutes.Hubs.MethodNames.NoteUpdated, dto => _noteEventRelay.SendNoteUpdated(dto));
        _hubConnection.On<Guid>(MNotesRoutes.Hubs.MethodNames.NoteDeleted, id => _noteEventRelay.SendNoteDeleted(id));
    }
